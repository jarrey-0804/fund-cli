...
class TestWindAdapterEnsureApi:
    ...
    def test_ensure_api_windpy_not_installed(self):
        ...
        with patch.dict('sys.modules', {'WindPy': None}):
            with pytest.raises(DataSourceError, match="WindPy 未安装"):
                adapter._ensure_api()
    ...
    def test_ensure_api_import_error(self):
        ...
        def raise_import_error(*args, **kwargs):
            raise ImportError("No module named 'WindPy'")
...
class TestWindAdapterP0Methods:
    ...
    def test_get_fund_info_raises_error(self):
        """测试 get_fund_info 抛出 DataSourceError"""
        adapter = WindAdapter()
        
        with patch.object(adapter, '_ensure_api'):
            with pytest.raises(DataSourceError, match="WindAdapter P0 方法待实现"):
                adapter.get_fund_info("000001")

    def test_get_all_fund_names_raises_error(self):
        """测试 get_all_fund_names 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_nav_raises_error(self):
        """测试 get_fund_nav 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_nav_with_dates_raises_error(self):
        """测试 get_fund_nav 带日期参数抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_etf_spot_raises_error(self):
        """测试 get_etf_spot 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_lof_spot_raises_error(self):
        """测试 get_lof_spot 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_manager_raises_error(self):
        """测试 get_fund_manager 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_holdings_raises_error(self):
        """测试 get_fund_holdings 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_holdings_with_date_raises_error(self):
        """测试 get_fund_holdings 带日期参数抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_asset_allocation_raises_error(self):
        """测试 get_fund_asset_allocation 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_asset_allocation_with_date_raises_error(self):
        """测试 get_fund_asset_allocation 带日期参数抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_rating_raises_error(self):
        """测试 get_fund_rating 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_get_fund_fee_raises_error(self):
        """测试 get_fund_fee 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_batch_get_fund_nav_raises_error(self):
        """测试 batch_get_fund_nav 抛出 DataSourceError"""
        adapter = WindAdapter()
    ...
    def test_batch_get_fund_nav_with_dates_raises_error(self):
        """测试 batch_get_fund_nav 带日期参数抛出 DataSourceError"""
        adapter = WindAdapter()
...
class TestWindAdapterEnsureApiCalled:
    ...
    def test_get_fund_info_calls_ensure_api(self):
        ...
        with patch.object(adapter, '_ensure_api') as mock_ensure:
            mock_ensure.side_effect = DataSourceError("WindAdapter P0 方法待实现（需要 WindPy 授权）")
